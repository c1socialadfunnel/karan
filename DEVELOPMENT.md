...
```bash
git remote add encore encore://simple-backend-g2ii
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/simple-backend-g2ii/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/simple-backend-g2ii/settings/integrations/github)
